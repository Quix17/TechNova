...
function generateBackupCodes() {
    ...
    fetch('/get_remaining_timeout', {
        ...
        .then(data => {
            ...
            // Falls ein Timeout aktiv ist, interne Warnung anzeigen
            if (remainingTimeout > 0) {
                showMessage("Du kannst erst in " + Math.ceil(remainingTimeout) + " Stunden erneut Backup-Codes generieren.", "msg-warning");
                return;
            }
            ...
            // Zeige die generierten Codes an (intern in der UI)
            ...
            fetch('/save_backup_codes', {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        fetch('/update_backup_code_info', {
                            ...
                            .then(data => {
                                if (data.success) {
                                    showMessage("Backup-Codes wurden erfolgreich gespeichert.", "msg-success");
                                } else {
                                    console.error("Fehler beim Aktualisieren der Generierungsanzahl.");
                                    showMessage("Fehler beim Speichern der Backup-Codes.", "msg-fail");
                                }
                            });
                    } else {
                ...
                .catch(error => {
                    ...
                    showMessage("Es gab einen Fehler bei der Anfrage.", "msg-fail");
                });
        });
}
